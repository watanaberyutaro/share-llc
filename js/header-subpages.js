// Header functionality for sub pages (not index)
// Only runs on pages with body class that is NOT 'page-index'

document.addEventListener('DOMContentLoaded', function() {
    // Check if this is NOT the index page
    if (document.body.classList.contains('page-index')) {
        return; // Exit if this is index page
    }
